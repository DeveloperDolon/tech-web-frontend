    ...
    return (
        <div className="md:h-[120vh] flex flex-col justify-center items-center">
            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-white dark:bg-white dark:text-black md:mt-0 mt-32 shadow-white shadow-xl">
                ...
                <p className="text-sm text-center sm:px-6 dark:text-gray-500 font-semibold ">Don&apos;t have an account?
                    <Link to="/sign_up" rel="noopener noreferrer" className="underline font-bold text-green-500">Sign up</Link>
                </p>
            </div>
        </div>
    );
