        ...
        <div className="pb-20">
            ...
            <div className="max-w-7xl mx-auto lg:px-0 px-5 my-10">
                ...
                <div className="sm:px-14 sm:py-14 px-5 py-14 rounded-lg my-10 text-white">
                    <h1 className="title-text text-4xl text-center font-semibold">Add New Product</h1>
                        ...
                        <div className="grid md:grid-cols-2 grid-cols-1 gap-6">
                            <div className="space-y-7">
                                <label className="block space-y-5 font-bold" htmlFor="name">Name <br />
                                    <input placeholder="Enter Product Name" className="block text-black w-full py-3 px-3 font-normal rounded-md" type="text" name="name" id="" />
                                </label>
                                <label className="block space-y-5 font-bold" htmlFor="brand">Brand Name <br />
                                    <input placeholder="Enter Brand Name" className="block text-black w-full py-3 px-3 font-normal rounded-md" type="text" name="brand" id="" />
                                </label>
                                <label className="block space-y-5 font-bold" htmlFor="type">Product Type <br />
                                    <input placeholder="Enter Product Type" className="block text-black w-full py-3 px-3 font-normal rounded-md" type="text" name="type" id="" />
                                </label>
                                <label className="block space-y-5 font-bold" htmlFor="rating">Rating <br />
                                    <input placeholder="Enter Rating Count" className="block text-black w-full py-3 px-3 font-normal rounded-md" type="text" name="rating" id="" />
                                </label>
                            </div>

                            <div className="space-y-7">
                                <label className="block space-y-5 font-bold" htmlFor="price">Price <br />
                                    <input placeholder="Enter Product Price" className="block text-black w-full py-3 px-3 font-normal rounded-md" type="text" name="price" id="" />
                                </label>
                                <label className="block space-y-5 font-bold" htmlFor="photo">Photo URL <br />
                                    <input placeholder="Enter photo URL" className="block text-black w-full py-3 px-3 font-normal rounded-md" type="text" name="photo" id="" />
                                </label>
                                <label className="block space-y-5 font-bold" htmlFor="description">Description <br />
                                    <textarea placeholder="Enter coffee details" className="block text-black w-full py-3 px-3 font-normal rounded-md h-[168px]" type="text" name="description" id="" />
                                </label>
                            </div>
                        </div>
