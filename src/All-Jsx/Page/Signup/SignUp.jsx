...
const SignUp = () => {
    const {createUserWithEmailPassword, googleLogin} = useContext(DataContext);
    ...
    const handleAnotherButton = () => {
        Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: "Only google login method is supported here.",
            footer: '<a href="">Why do I have this issue?</a>'
          })
    }
    ...
    return (
        ...
        <div className="absolute top-10 left-20">
            <Link to="/" className="text-black py-3 px-8 bg-gray-50 shadow-white shadow-2xl rounded-lg">Back To Home</Link>
        </div>
        ...
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-white dark:bg-white dark:text-black md:mt-0 mt-32 shadow-white shadow-xl">
            ...
            <form onSubmit={handleSignUp} noValidate="" action="" className="space-y-6">
                ...
                <div className="space-y-1 text-sm">
                    ...
                    <input type="text" name="photo" id="photo" placeholder="Photo URL" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" />
                </div>
                <div className="space-y-1 text-sm">
                ...
                <button className="block w-full p-3 text-center rounded-sm dark:text-gray-900 dark:bg-violet-400 font-semibold">Sign Up</button>
            </form>
            ...
            <div className="flex justify-center space-x-4">
                ...
                <button onClick={handleAnotherButton} aria-label="Log in with Twitter" className="p-3 rounded-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                ...
                <button onClick={handleAnotherButton} aria-label="Log in with GitHub" className="p-3 rounded-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
