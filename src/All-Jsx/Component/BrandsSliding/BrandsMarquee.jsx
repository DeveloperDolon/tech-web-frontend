    ...
    return (
        <div>
            <Marquee className="my-5 py-2">
                <div className=" w-[400px] p-4 shadow-lg rounded-lg mr-10">
                    <div className="flex flex-col items-center">
                        ...
                        <p className="font-semibold lg:text-xl text-base lg:leading-6 leading-5 text-gray-800 mt-3">Lukate Bruslee</p>
                        <p className="font-sans text-sm mb-2 mt-1">12.07.2023</p>
                        <p className="font-normal  md:text-base text-center text-sm leading-6 text-gray-600">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                    </div>
                </div>
                <div className=" w-[400px] p-4 shadow-lg rounded-lg mr-10">
                    <div className="flex flex-col items-center">
                        ...
                        <p className="font-semibold lg:text-xl text-base lg:leading-6 leading-5 text-gray-800 mt-3">পোড়া মন শুক্কুর আলী</p>
                        <p className="font-sans text-sm mb-2 mt-1">12.07.2023</p>
                        <p className="font-normal  md:text-base text-center text-sm leading-6 text-gray-600">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                    </div>
                </div>
                <div className=" w-[400px] p-4 shadow-lg rounded-lg mr-10">
                    <div className="flex flex-col items-center">
                        ...
                        <p className="font-semibold lg:text-xl text-base lg:leading-6 leading-5 text-gray-800 mt-3">Tom Crush</p>
                        <p className="font-sans text-sm mb-2 mt-1">12.07.2023</p>
                        <p className="font-normal  md:text-base text-center text-sm leading-6 text-gray-600">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                    </div>
                </div>
                <div className=" w-[400px] p-4 shadow-lg rounded-lg mr-10">
                    <div className="flex flex-col items-center">
                        ...
                        <p className="font-semibold lg:text-xl text-base lg:leading-6 leading-5 text-gray-800 mt-3">Nagin Paloyan</p>
                        <p className="font-sans text-sm mb-2 mt-1">12.07.2023</p>
                        <p className="font-normal  md:text-base text-center text-sm leading-6 text-gray-600">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                    </div>
                </div>
