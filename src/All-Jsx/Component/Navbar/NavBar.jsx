...
const NavBar = () => {
    ...
    const navBars = <>
        ...
        <li><NavLink to="/jd">Add Product</NavLink></li>
        <li><NavLink to="/jd">About Us</NavLink></li>
        <li><NavLink to="/jd">Contact Us</NavLink></li>
        <li><NavLink to="/jd">Blog</NavLink></li>
    </>;
        ...
        <>
            <div className="navbar bg-base-100">
                ...
                <div className="navbar-end gap-5 flex-wrap">
                    ...
                    <label
                            className="swap swap-rotate text-black p-3 rounded-full shadow-md">
                            ...
                            <svg className="swap-off fill-current lg:w-6 lg:h-6 md:w-8 md:h-8 w-3 h-3"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <path
